...
public class ViewCompletedAdapter  extends RecyclerView.Adapter<ViewCompletedAdapter.ViewHolder> {

    private Context context;
    private ArrayList<AlltournamentModel> arrayList;

    public ViewCompletedAdapter(Context context, ArrayList<AlltournamentModel> arrayList) {
    ...
    @NonNull
    @Override
    public ViewCompletedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.completed_tournament, parent, false);
