...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendcall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(ContactUs.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(ContactUs.this, "please give permission to call", Toast.LENGTH_LONG);
                    requestPermission();
                } else {
                    startActivity(i);
                }
        ...
        sendemail.setOnClickListener(v -> {
            ...
            i.putExtra(Intent.EXTRA_TEXT, "HI i Want this improvement in this app and i am facing this r" +
                    "problem in app ");
